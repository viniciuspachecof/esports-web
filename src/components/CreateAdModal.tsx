...
const CreateAdModal = () => {
  ...
  async function handleCreatedAd(event: React.FormEvent<HTMLFormElement>) {
      ...
      <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25'>
        ...
        <form onSubmit={handleCreatedAd} className='mt-8 flex flex-col gap-4'>
          <div className='flex flex-col gap-2'>
            ...
            <select id="game" name="game" className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-50' defaultValue="">
              <option value="">Seleciona o game que deseja jogar</option>
              {games.map((game) => (
          ...
          <footer className='mt-4 flex justify-end gap-4'>
            ...
            <button type='submit' className='bg-violet-500 px-5 h-12 rounded-md font-semibold flex items-center gap-3 hover:bg-zinc-600'>
